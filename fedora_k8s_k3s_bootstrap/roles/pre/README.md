...
Fedora OS preparation for K3s Kubernetes nodes. Replaces manual setup:
...
- Opens K3s firewall ports (6443 API, 10250 kubelet, flannel/wireguard, NodePorts, etcd for HA).
...
| `pre_firewall_manage` | `true` | Manage firewalld + K3s ports |
